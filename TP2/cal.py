...
def cal():
    ...
    filemenu.add_command(label="Base")
    filemenu.add_command(label="Scientific")
    menu.add_cascade(label="Type", menu=filemenu)
    ...
    button15 = Button(root, text='C', bg=button_bg, padx=10, pady=3,
                      command=lambda: backspace(entry), activebackground=button_active_bg)
    button15.grid(row=5, column=0, pady=5)

    button16 = Button(root, text='AC', bg=button_bg, padx=10, pady=3,
